...
export const dataLaporan: LaporanItem[] = [
  ...
  { id: '2',  kode: 'TUBEL-20260108-002',tanggal: '08 Jan 2026', bulan: 1,  tahun: 2026, layanan: 'Tugas Belajar Beasiswa',  nomorSurat: 'B/0102/KP.02.04/2026', status: 'ditolak',      pegawai: [{ nama: 'Siti Rahayu',    nip: '198703152011012002', jabatan: 'Pranata Komputer', unit: 'Pusdatin' }] },
  ...
  { id: '4',  kode: 'TUBEL-20260202-004',tanggal: '02 Feb 2026', bulan: 2,  tahun: 2026, layanan: 'Tugas Belajar Mandiri',   nomorSurat: 'B/0201/KP.02.04/2026', status: 'diverifikasi', pegawai: [{ nama: 'Eko Prasetyo',    nip: '199205182014011005', jabatan: 'Perencana',         unit: 'Biro Perencanaan' }] },
  ...
  { id: '7',  kode: 'TUBEL-20260305-007',tanggal: '05 Mar 2026', bulan: 3,  tahun: 2026, layanan: 'Tugas Belajar Beasiswa',  nomorSurat: 'B/0301/KP.02.04/2026', status: 'diverifikasi', pegawai: [{ nama: 'Hani Lestari',    nip: '199307122017012008', jabatan: 'Bendahara',         unit: 'Biro Keuangan' }] },
  ...
  { id: '10', kode: 'TUBEL-20260404-010',tanggal: '04 Apr 2026', bulan: 4,  tahun: 2026, layanan: 'Tugas Belajar Mandiri',   nomorSurat: 'B/0401/KP.02.04/2026', status: 'diverifikasi', pegawai: [{ nama: 'Budi Santoso',    nip: '199002202012011003', jabatan: 'Auditor',           unit: 'Inspektorat' }] },
  ...
  { id: '13', kode: 'TUBEL-20260510-013',tanggal: '10 Mei 2026', bulan: 5,  tahun: 2026, layanan: 'Tugas Belajar Beasiswa',  nomorSurat: 'B/0501/KP.02.04/2026', status: 'diverifikasi', pegawai: [{ nama: 'Fitri Handayani', nip: '198604252015012006', jabatan: 'Analis SDM',        unit: 'Biro Kepegawaian' }] },
  ...
  { id: '16', kode: 'TUBEL-20260601-016',tanggal: '01 Jun 2026', bulan: 6,  tahun: 2026, layanan: 'Tugas Belajar Mandiri',   nomorSurat: 'B/0601/KP.02.04/2026', status: 'diverifikasi', pegawai: [{ nama: 'Juwita Sari',     nip: '199410082019012010', jabatan: 'Analis Hukum',      unit: 'Biro Hukum' }] },
